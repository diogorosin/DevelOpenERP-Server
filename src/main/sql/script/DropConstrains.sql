...
ALTER TABLE IF EXISTS "Subject" DROP CONSTRAINT IF EXISTS "SubjectContactFK" CASCADE;
...
ALTER TABLE IF EXISTS "Company" DROP CONSTRAINT IF EXISTS "CompanyContactFK" CASCADE;
...
ALTER TABLE IF EXISTS "User" DROP CONSTRAINT IF EXISTS "UserCompanyFK" CASCADE;
