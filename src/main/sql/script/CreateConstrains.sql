...
ALTER TABLE "CompanyUser" ADD CONSTRAINT "CompanyUserPK" PRIMARY KEY("company", "user");
...
ALTER TABLE "User" ADD CONSTRAINT "UserLastLoggedInCompanyFK" FOREIGN KEY("lastLoggedInCompany") REFERENCES "Company"("identifier") ON DELETE SET NULL ON UPDATE CASCADE;

ALTER TABLE "CompanyUser" ADD CONSTRAINT "CompanyUserCompanyFK" FOREIGN KEY("company") REFERENCES "Company"("identifier") ON DELETE RESTRICT ON UPDATE CASCADE;
ALTER TABLE "CompanyUser" ADD CONSTRAINT "CompanyUserUserFK" FOREIGN KEY("user") REFERENCES "User"("identifier") ON DELETE RESTRICT ON UPDATE CASCADE;

ALTER TABLE "Token" ADD CONSTRAINT "TokenCompanyUserFK" FOREIGN KEY("company", "user") REFERENCES "CompanyUser"("company", "user") ON DELETE CASCADE ON UPDATE CASCADE;
